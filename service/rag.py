'''Invalid JSON: trailing characters at line 126 column 9 [type=json_invalid, input_value='{\n  "renewable_POs": {\...ur understanding, Other', input_type=str]
    For further information visit https://errors.pydantic.dev/2.10/v/json_invalid
2024-12-29 17:17:59,679 - rag - ERROR - Raw content that failed: 
    ...
    def query_model(self, context: str, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # Attempt to clean up any trailing characters
